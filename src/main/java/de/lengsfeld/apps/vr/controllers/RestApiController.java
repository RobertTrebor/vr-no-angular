...
public class RestApiController {
    ...
    public ResponseEntity<?> getGrave(@PathVariable("id") long id) {
        ...
        Optional<Grave> graveO = graveService.findById(id);
        Grave grave = graveO.get();
        if (grave == null) {
    ...
    public ResponseEntity<?> updateGrave(@PathVariable("id") long id, @RequestBody Grave grave) {
        ...
        Optional<Grave> currentGraveO = graveService.findById(id);
        Grave currentGrave = currentGraveO.get();
